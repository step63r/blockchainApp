...
export interface MyTimelockControllerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface MyTimelockController extends BaseContract {
  connect(runner?: ContractRunner | null): MyTimelockController;
  waitForDeployment(): Promise<this>;

  interface: MyTimelockControllerInterface;
